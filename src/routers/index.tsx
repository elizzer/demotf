...
import AuthorPage from "containers/dashboardpage/AuthorPage/AuthorPage";
...
import PrivacyPolicy from "containers/PageAbout/PrivacyPolicy";
import TermsofService from "containers/PageAbout/TermsofService";
...
import TripSummary from "containers/TripSummaryPage/TripSummary";
import TravellerInfo from "containers/TravellerInfoPage/TravellerInfo";
import PaymentDetails from "containers/TravellerInfoPage/PaymentDetails";
import ReviewPage from "containers/TravellerInfoPage/ReviewPage";
import AddCard from "containers/AddCardPage/AddCard";
import AddFrequentTraveller from "containers/dashboardpage/AddFrequentTraveller";
...
export const pages: Page[] = [
  ...
  { path: "/flight-deals/:dealName",exact:true ,component: ListingStayDetailPage },
  // //
  {
  ...
  { path: "/review&book", component: ReviewPage },
  { path: "/travellerinfo", component: TravellerInfo },
  { path: "/trip-summary/:dataIndex/:refId", component: TripSummary },
  { path: "/pay-done", component: PayPage },
  //
  { path: "/dashboard", component: DashboardPage },
  { path: "/add-frequent-traveller", component: AddFrequentTraveller },
