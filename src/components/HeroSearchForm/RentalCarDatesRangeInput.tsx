...
const OnewayDates: FC<OnewayDatesProps> = ({
  ...
  return (
    <div
      className={`OnewayDates relative flex-shrink-0 flex nc-flex-2-auto z-10 ${className}  ${
    ...
    >
      <div className="absolute inset-0 flex">
        <DateRangePicker
          ...
          daySize={windowSize.width > 1000 ? 56 : undefined}
          orientation={"horizontal"}
          showClearDates
          noBorder
          hideKeyboardShortcutsPanel
          numberOfMonths={
            numberOfMonths || (windowSize.width <= 1000 ? 2 : undefined)
          }
