...
const renderCard = (item: TaxonomyType, index: number, categoryCardType: string) => {
...
const SectionSliderNewCategories: FC<SectionSliderNewCategoriesProps> = ({
  heading = "Best Flight Deals",
  subHeading = "Here you may find your favorite trips ever!!",
  className = "",
  itemClassName = "",
  categories,
  itemPerRow = 5, 
...
console.log('[+]Categories rendred',categories)
  return (
